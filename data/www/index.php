            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2 active" aria-current="page" href="index.php">Domov</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2" href="storitve.php">Storitve</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2" href="Onas.php">O nas</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row pb-3">
                ...
                <div class="col">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="storitve.php" class="povezave text-decoration-none ">Naše storitve</a></li>
